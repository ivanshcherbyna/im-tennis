...
class MNP_Plugin_Invoice extends MNP_Plugin_Invoice_Controller {
	...
	public function findRecipientArea()
	{
		...
		$my_row = $wpdb->get_row("SELECT ref FROM {$wpdb->prefix}nova_poshta_city WHERE description = '$this->recipient_city'");
	...
	public function newFindRecipientArea()
	{
		...
		$results = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}nova_poshta_city WHERE description = '$this->recipient_city'", ARRAY_A);
